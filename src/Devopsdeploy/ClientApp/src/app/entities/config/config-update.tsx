  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="devopsdeployApp.config.home.createOrEditLabel">Create or edit a Config</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : configEntity} onSubmit={saveEntity}>
              <AvGroup>
                ...
                <AvInput id="config-id" type="text" className="form-control" name="id" readOnly={!isNew} required />
              </AvGroup>
              <AvGroup>
                <Label id="valueLabel" for="config-value">
                  Value
                </Label>
                <AvField
                  id="config-value"
