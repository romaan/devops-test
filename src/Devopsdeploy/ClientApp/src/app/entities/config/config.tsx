...
export interface IConfigProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`${match.url}/${config.id}`} color="info" size="sm">
