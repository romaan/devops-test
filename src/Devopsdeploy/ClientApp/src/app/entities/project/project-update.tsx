  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="devopsdeployApp.project.home.createOrEditLabel">Create or edit a Project</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : projectEntity} onSubmit={saveEntity}>
              <AvGroup>
                ...
                <AvInput id="project-id" type="text" className="form-control" name="id" readOnly={!isNew} required />
              </AvGroup>
              <AvGroup>
