...
export interface IEnvironmentDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const EnvironmentDetail = (props: IEnvironmentDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          Environment [<b>{environmentEntity.id}</b>]
        </h2>
        ...
        <Button tag={Link} to="/environment" replace color="info">
